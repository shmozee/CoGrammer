...
print("\nExample 3: ")
contents = ""
with open('T08\example.txt', 'r+') as f: # Open the file again, this time using the 'with' syntax
        for line in f:
...
f = open('T08\example.txt','r+', encoding='utf-8') # Open the file again!
